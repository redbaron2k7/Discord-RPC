...
document.addEventListener("DOMContentLoaded", () => {
		...
		if (settings.launchedpresence == false) {
			...
			fs.writeFile(`${dir}${slash}settings.json`, JSON.stringify(settings, null, 2), 'utf8', (err) => {
				if (err) { throw err }
					...
					dialog.showMessageBox(null, msg).then(result => {
						if (result.response == 1) {
							shell.openExternal('https://discord.gg/XafXuRKRbm')
						}
	...
	registerLinkToOpenInBrowser("github-button", "https://discord.gg/XafXuRKRbm")
	registerLinkToOpenInBrowser("discord-button", "https://discord.gg/XafXuRKRbm")
	registerLinkToOpenInBrowser("web-button", "https://discord.gg/XafXuRKRbm")
	registerLinkToOpenInBrowser("donate-button", "https://discord.gg/XafXuRKRbm")
	...
	registerLinkToOpenInBrowser("cliutility", "https://discord.gg/XafXuRKRbm")
	registerLinkToOpenInBrowser("t1c", "https://discord.gg/XafXuRKRbm")
	registerLinkToOpenInBrowser("kraxen", "https://discord.gg/XafXuRKRbm")
	registerLinkToOpenInBrowser("mikey", "https://discord.gg/XafXuRKRbm")
